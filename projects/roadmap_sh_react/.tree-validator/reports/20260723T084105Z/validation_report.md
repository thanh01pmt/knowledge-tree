...
- **Thời gian chạy:** 2026-07-23T08:41:05.547467+00:00
- **Kết quả:** ❌ FAIL
...
|---|---|---|---|
| topics | `REACT_FRAMEWORK` | category_codes | Cột 'category_codes' rỗng — node không có cha. |
...
| concepts | `REACT_ROUTER_NEXTJS` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |

### `LO_CONCEPT_UNCOVERED` (1) — Concept trong concepts.tsv không được LO nào trỏ đến (thiếu coverage)

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| concepts | `REACT_ROUTER_NEXTJS` | - | Concept 'React Routing & Server Side Rendering' (REACT_ROUTER_NEXTJS) không có LO nào trỏ đến trong learning-objectives.tsv. |
