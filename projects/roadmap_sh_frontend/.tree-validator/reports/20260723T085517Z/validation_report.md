...
- **Thời gian chạy:** 2026-07-23T08:55:17.298383+00:00
- **Kết quả:** ✅ PASS
- **Tổng số issue:** 9 (0 lỗi, 9 cảnh báo)
...
| topics | 4 |
| concepts | 22 |
| learning_objectives | 106 |

## Tổng hợp theo rule

| Rule | Mô tả | Số lượng |
|---|---|---|
| `ORPHAN_NODE` | Node không được node nào ở tầng dưới tham chiếu tới | 9 |
...
### `ORPHAN_NODE` (9) — Node không được node nào ở tầng dưới tham chiếu tới
