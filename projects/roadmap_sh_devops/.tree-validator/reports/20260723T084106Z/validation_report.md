...
- **Thời gian chạy:** 2026-07-23T08:41:06.009153+00:00
- **Kết quả:** ❌ FAIL
...
|---|---|---|---|
| topics | `DEVOPS_PRACTICES` | category_codes | Cột 'category_codes' rỗng — node không có cha. |
...
| concepts | `SYSTEM_MONITORING_LOGGING` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |

### `LO_CONCEPT_UNCOVERED` (1) — Concept trong concepts.tsv không được LO nào trỏ đến (thiếu coverage)

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| concepts | `SYSTEM_MONITORING_LOGGING` | - | Concept 'System Monitoring & Observability' (SYSTEM_MONITORING_LOGGING) không có LO nào trỏ đến trong learning-objectives.tsv. |
