...
- **Thời gian chạy:** 2026-07-23T08:41:06.176955+00:00
- **Kết quả:** ❌ FAIL
...
|---|---|---|---|
| topics | `PYTHON_LANGUAGE` | category_codes | Cột 'category_codes' rỗng — node không có cha. |
...
| concepts | `PYTHON_VIRTUAL_ENVS` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |

### `LO_CONCEPT_UNCOVERED` (1) — Concept trong concepts.tsv không được LO nào trỏ đến (thiếu coverage)

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| concepts | `PYTHON_VIRTUAL_ENVS` | - | Concept 'Virtual Environments & Package Managers' (PYTHON_VIRTUAL_ENVS) không có LO nào trỏ đến trong learning-objectives.tsv. |
