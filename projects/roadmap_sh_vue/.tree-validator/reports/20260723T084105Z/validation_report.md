...
- **Thời gian chạy:** 2026-07-23T08:41:05.634441+00:00
- **Kết quả:** ❌ FAIL
...
|---|---|---|---|
| topics | `VUE_FRAMEWORK` | category_codes | Cột 'category_codes' rỗng — node không có cha. |
...
| concepts | `VUE_ROUTER_NUXT` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |

### `LO_CONCEPT_UNCOVERED` (1) — Concept trong concepts.tsv không được LO nào trỏ đến (thiếu coverage)

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| concepts | `VUE_ROUTER_NUXT` | - | Concept 'Vue Router & Nuxt.js Framework' (VUE_ROUTER_NUXT) không có LO nào trỏ đến trong learning-objectives.tsv. |
