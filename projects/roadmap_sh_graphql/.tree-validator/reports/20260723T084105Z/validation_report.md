...
- **Thời gian chạy:** 2026-07-23T08:41:05.802113+00:00
- **Kết quả:** ❌ FAIL
...
|---|---|---|---|
| topics | `GRAPHQL_SPECIFICATION` | category_codes | Cột 'category_codes' rỗng — node không có cha. |
...
| concepts | `GRAPHQL_CLIENT_INTEGRATION` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |

### `LO_CONCEPT_UNCOVERED` (1) — Concept trong concepts.tsv không được LO nào trỏ đến (thiếu coverage)

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| concepts | `GRAPHQL_CLIENT_INTEGRATION` | - | Concept 'GraphQL Client Libraries & Caching' (GRAPHQL_CLIENT_INTEGRATION) không có LO nào trỏ đến trong learning-objectives.tsv. |
