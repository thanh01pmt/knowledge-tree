...
- **Thời gian chạy:** 2026-07-23T08:41:05.374629+00:00
- **Kết quả:** ❌ FAIL
...
|---|---|---|---|
| topics | `TYPESCRIPT_LANGUAGE` | category_codes | Cột 'category_codes' rỗng — node không có cha. |
...
| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| categories | `PROGRAMMING_LANGUAGES` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |
| concepts | `TYPESCRIPT_COMPILER_CONFIG` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |

### `LO_CONCEPT_UNCOVERED` (1) — Concept trong concepts.tsv không được LO nào trỏ đến (thiếu coverage)

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| concepts | `TYPESCRIPT_COMPILER_CONFIG` | - | Concept 'TSC Compiler & Build Pipeline' (TYPESCRIPT_COMPILER_CONFIG) không có LO nào trỏ đến trong learning-objectives.tsv. |
