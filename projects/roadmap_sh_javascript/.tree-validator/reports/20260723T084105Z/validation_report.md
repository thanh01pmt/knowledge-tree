...
- **Thời gian chạy:** 2026-07-23T08:41:05.462244+00:00
- **Kết quả:** ❌ FAIL
...
|---|---|---|---|
| topics | `JAVASCRIPT_ECOSYSTEM` | category_codes | Cột 'category_codes' rỗng — node không có cha. |
...
| concepts | `MODERN_ES6_FEATURES` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |

### `LO_CONCEPT_UNCOVERED` (1) — Concept trong concepts.tsv không được LO nào trỏ đến (thiếu coverage)

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| concepts | `MODERN_ES6_FEATURES` | - | Concept 'Modern ECMAScript Standards & Modules' (MODERN_ES6_FEATURES) không có LO nào trỏ đến trong learning-objectives.tsv. |
