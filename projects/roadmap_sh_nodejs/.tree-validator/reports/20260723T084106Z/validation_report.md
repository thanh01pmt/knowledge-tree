...
- **Thời gian chạy:** 2026-07-23T08:41:06.092366+00:00
- **Kết quả:** ❌ FAIL
...
|---|---|---|---|
| topics | `NODEJS_RUNTIME` | category_codes | Cột 'category_codes' rỗng — node không có cha. |
...
| concepts | `PACKAGE_MANAGEMENT` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |

### `LO_CONCEPT_UNCOVERED` (1) — Concept trong concepts.tsv không được LO nào trỏ đến (thiếu coverage)

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| concepts | `PACKAGE_MANAGEMENT` | - | Concept 'Node.js Package & Process Management' (PACKAGE_MANAGEMENT) không có LO nào trỏ đến trong learning-objectives.tsv. |
