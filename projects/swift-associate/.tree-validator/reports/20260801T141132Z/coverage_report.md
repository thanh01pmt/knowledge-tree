...
- **Thời gian kiểm tra:** 2026-08-01T14:11:32.292286+00:00
...
| `UI_MODIFIERS_CONCEPT` | UI Modifiers | `ULO-UI_MODIFIERS_CONCEPT-03` |
...
| `PROJECT_ASSETS_MANAGEMENT` | Project Assets Management | `ULO-PROJECT_ASSETS_MANAGEMENT-01`, `ULO-PROJECT_ASSETS_MANAGEMENT-03` |
| `WHILE_LOOP` | While Loop | `ULO-WHILE_LOOP-03` |
...
| `ARRAY_OPERATIONS` | Array Operations | `ULO-ARRAY_OPERATIONS-03` |
...
| `EVENT_HANDLERS_CONCEPT` | Events and Event Handling | `ULO-EVENT_HANDLERS_CONCEPT-02` |
...
| `STATE_PROPERTY_WRAPPER` | State Property Wrapper | `ULO-STATE_PROPERTY_WRAPPER-02` |
...
| `DECLARATIVE_UI_PARADIGM` | Declarative UI Paradigm | `ULO-DECLARATIVE_UI_PARADIGM-03` |
...
| `SYNTAX_VS_RUNTIME_ERRORS` | Syntax vs Runtime Errors | `ULO-SYNTAX_VS_RUNTIME_ERRORS-03` |
