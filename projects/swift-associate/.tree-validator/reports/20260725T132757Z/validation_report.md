...
- **Thời gian chạy:** 2026-07-25T13:27:57.346344+00:00
- **Kết quả:** ❌ FAIL
- **Tổng số issue:** 460 (386 lỗi, 74 cảnh báo)
...
| topics | 16 |
| concepts | 24 |
| learning_objectives | 249 |

## Tổng hợp theo rule

| Rule | Mô tả | Số lượng |
|---|---|---|
| `EMPTY_PARENT_REF` | Không có tham chiếu nào tới bảng cha (node lơ lửng) | 175 |
| `LO_BROKEN_PARENT_REF` | parent_lo_code trỏ tới 1 LO không tồn tại | 175 |
...
| `LO_CONCEPT_UNCOVERED` | Concept trong concepts.tsv không được LO nào trỏ đến (thiếu coverage) | 6 |
| `INCONSISTENT_LINE_ENDINGS` | File dùng line-ending khác với đa số các file còn lại | 3 |

## ❌ Lỗi (ERROR) — cần sửa

### `EMPTY_PARENT_REF` (175) — Không có tham chiếu nào tới bảng cha (node lơ lửng)

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| learning_objectives | `CIO-ARRAY_OPERATIONS-ACCESS_ARRAY_ELEMENT` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-ARRAY_OPERATIONS-ZERO_BASED_INDEX` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-ARRAY_OPERATIONS-SEQUENTIAL_ARRAY_TRAVERSAL` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-ARRAY_OPERATIONS-MODIFY_ARRAY_ELEMENT` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-LOCAL_VIEW_STATE-LOCAL_STATE_SYNC_ROLE` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-LOCAL_VIEW_STATE-CONTROL_UI_PROPERTIES` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-LOCAL_VIEW_STATE-UPDATE_LOCAL_STATE` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-LOCAL_VIEW_STATE-TRACE_LOCAL_STATE_LIFECYCLE` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-LOCAL_VIEW_STATE-DETERMINE_LOCAL_STATE_SCOPE` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-STATE_PROPERTY_WRAPPER-STATE_TRIGGERED_RERENDER` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-STATE_PROPERTY_WRAPPER-STATE_WRAPPER_DECOUPLING` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-STATE_PROPERTY_WRAPPER-OWNERSHIP_SHARING_SEMANTICS` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-STATE_PROPERTY_WRAPPER-EVALUATE_APPROPRIATE_WRAPPER` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-WHILE_LOOP-CONDITION_CONTROLLED_LOOP` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-WHILE_LOOP-CONDITION_FIRST_REPETITION` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-WHILE_LOOP-LOOP_TERMINATION_CONDITION` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-WHILE_LOOP-DYNAMIC_CONDITION_REPETITION` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-WHILE_LOOP-SENTINEL_CONTROLLED_REPETITION` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-SYNTAX_VS_RUNTIME_ERRORS-DISTINGUISH_SYNTAX_RUNTIME` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-SYNTAX_VS_RUNTIME_ERRORS-SYNTAX_RUNTIME_CAUSES` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-SYNTAX_VS_RUNTIME_ERRORS-CLASSIFY_ERROR_DETECTION` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-SYNTAX_VS_RUNTIME_ERRORS-IDENTIFY_ERROR_TYPE` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-SYNTAX_VS_RUNTIME_ERRORS-ANALYZE_ERROR_MESSAGES` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-REFERENCE_TYPE_DECLARATION-IDENTIFY_REFERENCE_SYNTAX` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-REFERENCE_TYPE_DECLARATION-COMPARE_REFERENCE_VALUE` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-REFERENCE_TYPE_DECLARATION-ANALYZE_REFERENCE_IMPACT` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-REFERENCE_TYPE_DECLARATION-DECLARE_REFERENCE_NULL` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-REFERENCE_TYPE_DECLARATION-DECLARE_REFERENCE_NULL_2` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-DISTINGUISH_TIME_CONTROL` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-DISTINGUISH_TIME_CONTROL_2` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-WRAP_STATE_CHANGES` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-WRAP_STATE_CHANGES_2` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-ANALYZE_PERFORMANCE_REUSABILITY` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-ANALYZE_PERFORMANCE_REUSABILITY_2` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-EVALUATE_CUSTOMIZABILITY_UX` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-EVALUATE_CUSTOMIZABILITY_UX_2` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-DECLARATIVE_UI_PARADIGM-DESCRIBE_DESIRED_STATE` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-DECLARATIVE_UI_PARADIGM-COMPARE_DECLARATIVE_IMPERATIVE` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-DECLARATIVE_UI_PARADIGM-EVALUATE_PERFORMANCE` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-DECLARATIVE_UI_PARADIGM-EVALUATE_SCALABILITY` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-LIST_AND_CLASSIFY` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-ORDER_AFFECTS_DISPLAY` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-COMBINE_MODIFIERS` | concept_codes | Cột 'concept_codes' rỗng — node không có cha. |
...
### `LO_BROKEN_PARENT_REF` (175) — parent_lo_code trỏ tới 1 LO không tồn tại

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| learning_objectives | `CIO-ARRAY_OPERATIONS-ACCESS_ARRAY_ELEMENT` | parent_lo_code | parent_lo_code 'ULO-ARRAY_OPERATIONS-01' không tồn tại. |
| learning_objectives | `CIO-ARRAY_OPERATIONS-ZERO_BASED_INDEX` | parent_lo_code | parent_lo_code 'ULO-ARRAY_OPERATIONS-02' không tồn tại. |
| learning_objectives | `CIO-ARRAY_OPERATIONS-SEQUENTIAL_ARRAY_TRAVERSAL` | parent_lo_code | parent_lo_code 'ULO-ARRAY_OPERATIONS-03' không tồn tại. |
| learning_objectives | `CIO-ARRAY_OPERATIONS-MODIFY_ARRAY_ELEMENT` | parent_lo_code | parent_lo_code 'ULO-ARRAY_OPERATIONS-03' không tồn tại. |
| learning_objectives | `CIO-LOCAL_VIEW_STATE-LOCAL_STATE_SYNC_ROLE` | parent_lo_code | parent_lo_code 'ULO-LOCAL_VIEW_STATE-01' không tồn tại. |
| learning_objectives | `CIO-LOCAL_VIEW_STATE-CONTROL_UI_PROPERTIES` | parent_lo_code | parent_lo_code 'ULO-LOCAL_VIEW_STATE-02' không tồn tại. |
| learning_objectives | `CIO-LOCAL_VIEW_STATE-UPDATE_LOCAL_STATE` | parent_lo_code | parent_lo_code 'ULO-LOCAL_VIEW_STATE-02' không tồn tại. |
| learning_objectives | `CIO-LOCAL_VIEW_STATE-TRACE_LOCAL_STATE_LIFECYCLE` | parent_lo_code | parent_lo_code 'ULO-LOCAL_VIEW_STATE-03' không tồn tại. |
| learning_objectives | `CIO-LOCAL_VIEW_STATE-DETERMINE_LOCAL_STATE_SCOPE` | parent_lo_code | parent_lo_code 'ULO-LOCAL_VIEW_STATE-03' không tồn tại. |
| learning_objectives | `CIO-STATE_PROPERTY_WRAPPER-STATE_TRIGGERED_RERENDER` | parent_lo_code | parent_lo_code 'ULO-STATE_PROPERTY_WRAPPER-01' không tồn tại. |
| learning_objectives | `CIO-STATE_PROPERTY_WRAPPER-STATE_WRAPPER_DECOUPLING` | parent_lo_code | parent_lo_code 'ULO-STATE_PROPERTY_WRAPPER-01' không tồn tại. |
| learning_objectives | `CIO-STATE_PROPERTY_WRAPPER-OWNERSHIP_SHARING_SEMANTICS` | parent_lo_code | parent_lo_code 'ULO-STATE_PROPERTY_WRAPPER-03' không tồn tại. |
| learning_objectives | `CIO-STATE_PROPERTY_WRAPPER-EVALUATE_APPROPRIATE_WRAPPER` | parent_lo_code | parent_lo_code 'ULO-STATE_PROPERTY_WRAPPER-03' không tồn tại. |
| learning_objectives | `CIO-WHILE_LOOP-CONDITION_CONTROLLED_LOOP` | parent_lo_code | parent_lo_code 'ULO-WHILE_LOOP-01' không tồn tại. |
| learning_objectives | `CIO-WHILE_LOOP-CONDITION_FIRST_REPETITION` | parent_lo_code | parent_lo_code 'ULO-WHILE_LOOP-02' không tồn tại. |
| learning_objectives | `CIO-WHILE_LOOP-LOOP_TERMINATION_CONDITION` | parent_lo_code | parent_lo_code 'ULO-WHILE_LOOP-02' không tồn tại. |
| learning_objectives | `CIO-WHILE_LOOP-DYNAMIC_CONDITION_REPETITION` | parent_lo_code | parent_lo_code 'ULO-WHILE_LOOP-03' không tồn tại. |
| learning_objectives | `CIO-WHILE_LOOP-SENTINEL_CONTROLLED_REPETITION` | parent_lo_code | parent_lo_code 'ULO-WHILE_LOOP-03' không tồn tại. |
| learning_objectives | `CIO-SYNTAX_VS_RUNTIME_ERRORS-DISTINGUISH_SYNTAX_RUNTIME` | parent_lo_code | parent_lo_code 'ULO-SYNTAX_VS_RUNTIME_ERRORS-01' không tồn tại. |
| learning_objectives | `CIO-SYNTAX_VS_RUNTIME_ERRORS-SYNTAX_RUNTIME_CAUSES` | parent_lo_code | parent_lo_code 'ULO-SYNTAX_VS_RUNTIME_ERRORS-02' không tồn tại. |
| learning_objectives | `CIO-SYNTAX_VS_RUNTIME_ERRORS-CLASSIFY_ERROR_DETECTION` | parent_lo_code | parent_lo_code 'ULO-SYNTAX_VS_RUNTIME_ERRORS-02' không tồn tại. |
| learning_objectives | `CIO-SYNTAX_VS_RUNTIME_ERRORS-IDENTIFY_ERROR_TYPE` | parent_lo_code | parent_lo_code 'ULO-SYNTAX_VS_RUNTIME_ERRORS-03' không tồn tại. |
| learning_objectives | `CIO-SYNTAX_VS_RUNTIME_ERRORS-ANALYZE_ERROR_MESSAGES` | parent_lo_code | parent_lo_code 'ULO-SYNTAX_VS_RUNTIME_ERRORS-03' không tồn tại. |
| learning_objectives | `CIO-REFERENCE_TYPE_DECLARATION-IDENTIFY_REFERENCE_SYNTAX` | parent_lo_code | parent_lo_code 'ULO-REFERENCE_TYPE_DECLARATION-01' không tồn tại. |
| learning_objectives | `CIO-REFERENCE_TYPE_DECLARATION-COMPARE_REFERENCE_VALUE` | parent_lo_code | parent_lo_code 'ULO-REFERENCE_TYPE_DECLARATION-02' không tồn tại. |
| learning_objectives | `CIO-REFERENCE_TYPE_DECLARATION-ANALYZE_REFERENCE_IMPACT` | parent_lo_code | parent_lo_code 'ULO-REFERENCE_TYPE_DECLARATION-02' không tồn tại. |
| learning_objectives | `CIO-REFERENCE_TYPE_DECLARATION-DECLARE_REFERENCE_NULL` | parent_lo_code | parent_lo_code 'ULO-REFERENCE_TYPE_DECLARATION-03' không tồn tại. |
| learning_objectives | `CIO-REFERENCE_TYPE_DECLARATION-DECLARE_REFERENCE_NULL_2` | parent_lo_code | parent_lo_code 'ULO-REFERENCE_TYPE_DECLARATION-03' không tồn tại. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-DISTINGUISH_TIME_CONTROL` | parent_lo_code | parent_lo_code 'ULO-IMPLICIT_EXPLICIT_ANIMATION-01' không tồn tại. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-DISTINGUISH_TIME_CONTROL_2` | parent_lo_code | parent_lo_code 'ULO-IMPLICIT_EXPLICIT_ANIMATION-01' không tồn tại. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-WRAP_STATE_CHANGES` | parent_lo_code | parent_lo_code 'ULO-IMPLICIT_EXPLICIT_ANIMATION-02' không tồn tại. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-WRAP_STATE_CHANGES_2` | parent_lo_code | parent_lo_code 'ULO-IMPLICIT_EXPLICIT_ANIMATION-02' không tồn tại. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-ANALYZE_PERFORMANCE_REUSABILITY` | parent_lo_code | parent_lo_code 'ULO-IMPLICIT_EXPLICIT_ANIMATION-03' không tồn tại. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-ANALYZE_PERFORMANCE_REUSABILITY_2` | parent_lo_code | parent_lo_code 'ULO-IMPLICIT_EXPLICIT_ANIMATION-03' không tồn tại. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-EVALUATE_CUSTOMIZABILITY_UX` | parent_lo_code | parent_lo_code 'ULO-IMPLICIT_EXPLICIT_ANIMATION-04' không tồn tại. |
| learning_objectives | `CIO-IMPLICIT_EXPLICIT_ANIMATION-EVALUATE_CUSTOMIZABILITY_UX_2` | parent_lo_code | parent_lo_code 'ULO-IMPLICIT_EXPLICIT_ANIMATION-04' không tồn tại. |
| learning_objectives | `CIO-DECLARATIVE_UI_PARADIGM-DESCRIBE_DESIRED_STATE` | parent_lo_code | parent_lo_code 'ULO-DECLARATIVE_UI_PARADIGM-01' không tồn tại. |
| learning_objectives | `CIO-DECLARATIVE_UI_PARADIGM-COMPARE_DECLARATIVE_IMPERATIVE` | parent_lo_code | parent_lo_code 'ULO-DECLARATIVE_UI_PARADIGM-01' không tồn tại. |
| learning_objectives | `CIO-DECLARATIVE_UI_PARADIGM-EVALUATE_PERFORMANCE` | parent_lo_code | parent_lo_code 'ULO-DECLARATIVE_UI_PARADIGM-04' không tồn tại. |
| learning_objectives | `CIO-DECLARATIVE_UI_PARADIGM-EVALUATE_SCALABILITY` | parent_lo_code | parent_lo_code 'ULO-DECLARATIVE_UI_PARADIGM-04' không tồn tại. |
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-LIST_AND_CLASSIFY` | parent_lo_code | parent_lo_code 'ULO-UI_MODIFIERS_CONCEPT-01' không tồn tại. |
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-ORDER_AFFECTS_DISPLAY` | parent_lo_code | parent_lo_code 'ULO-UI_MODIFIERS_CONCEPT-02' không tồn tại. |
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-COMBINE_MODIFIERS` | parent_lo_code | parent_lo_code 'ULO-UI_MODIFIERS_CONCEPT-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-APPLY_VISUAL_EVALUATION_CRITERIA` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-04-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-APPLY_VISUAL_EVALUATION_CRITERIA_2` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-04-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMPARE_SWIFTUI_DESIGN_AGAINST_CONSISTENCY_PRINCIPLE` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-04-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMPARE_SWIFTUI_DESIGN_AGAINST_CONSISTENCY_PRINCIPLE_2` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-04-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_SECURITY_CHALLENGES_IN_SWIFT_APPS_BY_IMPACT_DATA_BREACH_DENIAL_OF_SERVICE` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_SECURITY_CHALLENGES_IN_SWIFT_APPS_BY_IMPACT_DATA_BREACH_DENIAL_OF_SERVICE_2` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_SWIFT_SPECIFIC_CHECKLIST_TO_IDENTIFY_INSECURE_NETWORK_REQUESTS_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_SWIFT_SPECIFIC_CHECKLIST_TO_IDENTIFY_INSECURE_NETWORK_REQUESTS_IN_SWIFT_2` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_IMPACT_OF_SWIFT_DENIAL_OF_SERVICE_ON_AVAILABILITY` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_IMPACT_OF_SWIFT_DENIAL_OF_SERVICE_ON_AVAILABILITY_2` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_SWIFTUI_VIEW_COMPONENTS` | parent_lo_code | parent_lo_code 'CIO-VIEW_CONCEPT-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_UIKIT_VIEW_COMPONENTS` | parent_lo_code | parent_lo_code 'CIO-VIEW_CONCEPT-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_TAP_INTERACTION_FLOW_IN_SWIFTUI` | parent_lo_code | parent_lo_code 'CIO-VIEW_CONCEPT-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_TEXT_INPUT_INTERACTION_FLOW_IN_SWIFTUI` | parent_lo_code | parent_lo_code 'CIO-VIEW_CONCEPT-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-MODEL_VIEW_AS_SWIFTUI_STRUCT` | parent_lo_code | parent_lo_code 'CIO-VIEW_CONCEPT-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-MODEL_VIEW_AS_UIKIT_UIVIEW_SUBCLASS` | parent_lo_code | parent_lo_code 'CIO-VIEW_CONCEPT-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_INTEGER_VALUES_TO_INT_TYPE` | parent_lo_code | parent_lo_code 'CIO-DATA_TYPES-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_STRING_VALUES_TO_STRING_TYPE` | parent_lo_code | parent_lo_code 'CIO-DATA_TYPES-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMPARE_MEMORY_SIZE_OF_INTEGER_TYPES` | parent_lo_code | parent_lo_code 'CIO-DATA_TYPES-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMPARE_STORAGE_OF_FLOAT_AND_DOUBLE` | parent_lo_code | parent_lo_code 'CIO-DATA_TYPES-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CHOOSE_SWIFT_DATA_TYPE_BASED_ON_REQUIRED_OPERATIONS` | parent_lo_code | parent_lo_code 'CIO-DATA_TYPES-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CHOOSE_SWIFT_DATA_TYPE_BASED_ON_REQUIRED_OPERATIONS_2` | parent_lo_code | parent_lo_code 'CIO-DATA_TYPES-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CONVERT_DATA_TYPES_USING_SWIFT_TYPE_CASTING` | parent_lo_code | parent_lo_code 'CIO-DATA_TYPES-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CONVERT_DATA_TYPES_USING_SWIFT_TYPE_CASTING_2` | parent_lo_code | parent_lo_code 'CIO-DATA_TYPES-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DISTINGUISH_SEQUENCE_BRANCH_AND_LOOP_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DISTINGUISH_IF_ELSE_AND_SWITCH_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DESCRIBE_EXECUTION_ORDER_OF_SWITCH_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DESCRIBE_EXECUTION_ORDER_OF_SWITCH_IN_SWIFT_2` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-TRACE_VARIABLE_VALUES_THROUGH_FOR_IN_LOOP_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-TRACE_VARIABLE_VALUES_THROUGH_FOR_IN_LOOP_IN_SWIFT_2` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-TRACE_EXECUTION_PATH_OF_SWITCH_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-TRACE_EXECUTION_PATH_OF_SWITCH_IN_SWIFT_2` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CHECK_EXHAUSTIVENESS_OF_SWITCH_CASES_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-VERIFY_LOOP_TERMINATION_CONDITION_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DETECT_INFINITE_LOOP_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DETECT_NON_EXHAUSTIVE_SWITCH_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-CONTROL_FLOW-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_SWIFT_DATA_TYPES_BY_STORAGE_AND_RANGE` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_SWIFT_COLLECTION_TYPES_BY_STORAGE_AND_RANGE` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-IDENTIFY_STATIC_TYPING_IN_SWIFT_VIA_TYPE_ANNOTATION_AND_INFERENCE` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMPARE_STATIC_VS_DYNAMIC_TYPING_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_CONTRAST_IN_SWIFTUI_INTERFACE` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DESCRIBE_THE_STEPS_OF_STATIC_TYPE_CHECKING_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-APPLY_SWIFT_TYPE_INFERENCE_TO_DETERMINE_EXPRESSION_TYPE` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_SWIFT_TYPE_INFERENCE_IN_FUNCTION_AND_CLOSURE_CONTEXT` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_CONTRAST_IN_SWIFTUI_INTERFACE_2` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-SUGGEST_WAYS_TO_FIX_TYPE_ERRORS_BASED_ON_SWIFT_ERROR_MESSAGES` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-SIMULATE_SWIFT_TYPE_FLOW_TO_DETECT_ERRORS` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-TRACE_SWIFT_TYPE_FLOW_IN_COMPLEX_PROGRAMS` | parent_lo_code | parent_lo_code 'CIO-TYPE_SYSTEM-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_CONTRAST_IN_SWIFTUI_INTERFACE_3` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-EVALUATE_CONTRAST_IN_SWIFTUI_DESIGN` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-APPLY_SYMMETRIC_BALANCE_IN` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-APPLY_ASYMMETRIC_BALANCE_IN` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_GOLDEN_RATIO_GRID` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CALCULATE_GOLDEN_RATIO_LAYOUT` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-GROUP_RELATED_ELEMENTS_IN` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_PADDING_AND_OVERLAY` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_COLOR_PALETTE_PSYCHOLOGY` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMPARE_COLOR_PALETTES_IN` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-EVALUATE_WHITESPACE_IMPACT_ON` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMPARE_WHITESPACE_LEVELS_IN` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-APPLY_VISUAL_EVALUATION_CRITERIA_3` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-04-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_VISUAL_LAYOUT_WITH` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-04-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMPARE_DESIGN_PROXIMITY_USING` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-04-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-EVALUATE_DESIGN_CONSISTENCY_USING` | parent_lo_code | parent_lo_code 'CIO-VISUAL_DESIGN-04-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_SECURITY_CHALLENGES_BY` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_SECURITY_CHALLENGES_USING` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-IDENTIFY_SECURITY_CHALLENGE_TYPE` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DETECT_KEYCHAIN_STORAGE_VULNERABILITIES` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_IMPACT_OF_SQL` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_IMPACT_OF_PLAINTEXT` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-EVALUATE_SEVERITY_OF_SECURITY` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CLASSIFY_SEVERITY_OF_SWIFT` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-APPLY_5_WHYS_TECHNIQUE` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_FISHBONE_DIAGRAM_TO` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CONSTRUCT_CAUSE_EFFECT_CHAIN` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-MODEL_ATTACK_CHAIN_FOR` | parent_lo_code | parent_lo_code 'CIO-SECURITY_CHALLENGES-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-EXECUTE_SEQUENTIAL_DEBUGGING_PROCESS` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-APPLY_DEBUGGING_WORKFLOW_USING` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-SET_CONDITIONAL_BREAKPOINT_IN` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING_02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_BREAKPOINT_ACTION_TO` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING_02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_PRINT_WITH_LEVEL_PREFIX` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING_02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_OS_LOG_WITH_LOG_LEVELS` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING_02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_STEP_INTO_AND_STEP_OUT_IN_XCODE` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING_02-03' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_STEP_INTO_AND_STEP_OUT_IN_XCODE_2` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING_02-03' không tồn tại. |
| learning_objectives | `SIO-SWIFT-INSERT_PRINT_AT_MIDPOINT` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING_03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_ASSERT_OR_PRECONDITION_AT_MIDPOINT` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING_03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_5_WHYS_ON_SWIFT_LOG` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING_03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMBINE_CONDITIONAL_BREAKPOINT_WITH_5_WHYS` | parent_lo_code | parent_lo_code 'CIO-DEBUGGING_03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DESCRIBE_STRUCT_MEMBERWISE_INITIALIZATION` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DESCRIBE_STRUCT_MEMBERWISE_INITIALIZATION_2` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_HOW_INITIALIZER_PARAMETERS` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DISTINGUISH_BETWEEN_LABELED_AND` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CALL_A_SWIFT_CLASS` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-INITIALIZE_A_SWIFT_STRUCT` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-CREATE_A_SWIFT_OBJECT` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_DEFAULT_PROPERTY_VALUES` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_02-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMPARE_DIRECT_INITIALIZATION_VIA` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_ADVANTAGES_OF_FACTORY` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_HOW_DEPENDENCY_INJECTION` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-COMPARE_CONSTRUCTOR_INJECTION_VS` | parent_lo_code | parent_lo_code 'CIO-OBJECT_INSTANTIATION_03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-IMPLEMENT_EVENT_DRIVEN_PATTERN_IN_SWIFT_USING_SWIFTUIS_ONTAPGESTURE_AND_ONCHANGE_MODIFIERS` | parent_lo_code | parent_lo_code 'CIO-EVENT_HANDLERS_CONCEPT-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-IMPLEMENT_EVENT_DRIVEN_PATTERN_IN_SWIFT_USING_SWIFTUIS_ONTAPGESTURE_AND_ONCHANGE_MODIFIERS_2` | parent_lo_code | parent_lo_code 'CIO-EVENT_HANDLERS_CONCEPT-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-TRACE_EVENT_FLOW_FROM_USER_ACTION_TO_HANDLER_INVOCATION_IN_SWIFT_USING_UIAPPLICATION_AND_UIRESPONDER_CHAIN` | parent_lo_code | parent_lo_code 'CIO-EVENT_HANDLERS_CONCEPT-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-TRACE_EVENT_FLOW_IN_SWIFTUI_USING_THE_VIEW_HIERARCHY_AND_ONRECEIVE_MODIFIER` | parent_lo_code | parent_lo_code 'CIO-EVENT_HANDLERS_CONCEPT-01-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-REGISTER_CALLBACK_TO_UIBUTTONS_TOUCHUPINSIDE_EVENT_IN_SWIFT_USING_ADDTARGET_ACTION_FOR` | parent_lo_code | parent_lo_code 'CIO-EVENT_HANDLERS_CONCEPT-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-REGISTER_CALLBACK_TO_SWIFTUI_BUTTONS_ACTION_CLOSURE` | parent_lo_code | parent_lo_code 'CIO-EVENT_HANDLERS_CONCEPT-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_EVENT_PROPAGATION_IN_SWIFTUI_USING_ALLOWSHITTESTING_AND_CONTENTSHAPE_TO_CONTROL_TOUCH_DELIVERY` | parent_lo_code | parent_lo_code 'CIO-EVENT_HANDLERS_CONCEPT-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ANALYZE_EVENT_PROPAGATION_IN_SWIFTUI_USING_ALLOWSHITTESTING_AND_CONTENTSHAPE_TO_CONTROL_TOUCH_DELIVERY_2` | parent_lo_code | parent_lo_code 'CIO-EVENT_HANDLERS_CONCEPT-03-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-HANDLE_MULTIPLE_EVENTS_TOUCHDOWN_TOUCHUPINSIDE_ON_A_SINGLE_UIBUTTON_IN_SWIFT_USING_SEPARATE_IBACTION_METHODS` | parent_lo_code | parent_lo_code 'CIO-EVENT_HANDLERS_CONCEPT-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-HANDLE_MULTIPLE_EVENTS_TAP_LONGPRESS_ON_A_SINGLE_SWIFTUI_VIEW_USING_SIMULTANEOUSGESTURE_AND_HIGHPRIORITYGESTURE` | parent_lo_code | parent_lo_code 'CIO-EVENT_HANDLERS_CONCEPT-03-02' không tồn tại. |
| learning_objectives | `SIO-SWIFT-IDENTIFY_PROPERTY_AS_KEY_VALUE_PAIR_USING_SWIFT_SYNTAX` | parent_lo_code | parent_lo_code 'CIO-OBJECT_PROPERTIES-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DISTINGUISH_STORED_AND_COMPUTED_PROPERTIES_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-OBJECT_PROPERTIES-01-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-APPLY_PROPERTY_OBSERVERS_TO_MANAGE_STATE_CHANGES_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-OBJECT_PROPERTIES-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_COMPUTED_PROPERTY_TO_PROVIDE_READ_ONLY_OR_DERIVED_STATE_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-OBJECT_PROPERTIES-02-01' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ACCESS_AND_UPDATE_STORED_PROPERTY_VIA_INSTANCE_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-OBJECT_PROPERTIES-03-1' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_SUBSCRIPT_TO_ACCESS_AND_UPDATE_KEY_VALUE_STATE_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-OBJECT_PROPERTIES-03-1' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DEFINE_CUSTOM_GETTER_AND_SETTER_FOR_COMPUTED_PROPERTY_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-OBJECT_PROPERTIES-03-2' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_ACCESS_CONTROL_TO_RESTRICT_PROPERTY_WRITE_ACCESS_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-OBJECT_PROPERTIES-03-2' không tồn tại. |
| learning_objectives | `SIO-SWIFT-IDENTIFY_RETURN_STATEMENT_SYNTAX_IN_SWIFT_FUNCTIONS` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-01-1' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DISTINGUISH_RETURN_TYPES_IN_SWIFT_VOID_OPTIONAL_TUPLE` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-01-1' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DISTINGUISH_LOCAL_AND_GLOBAL_VARIABLES_IN_SWIFT_BASED_ON_DECLARATION_POSITION` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-01-2' không tồn tại. |
| learning_objectives | `SIO-SWIFT-IDENTIFY_VARIABLE_SCOPE_WITHIN_SWIFT_CODE_BLOCKS_USING_BRACES` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-01-2' không tồn tại. |
| learning_objectives | `SIO-SWIFT-EXPLAIN_LOCAL_VARIABLE_SCOPE_AND_RETURN_VALUE_MECHANISM_IN_SWIFT_FUNCTIONS` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-02-1' không tồn tại. |
| learning_objectives | `SIO-SWIFT-EXPLAIN_THE_FLOW_OF_RETURN_VALUE_FROM_A_SWIFT_FUNCTION_TO_THE_CALLER` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-02-1' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DESCRIBE_VARIABLE_ACCESS_RULES_BASED_ON_SCOPE_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-02-2' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DESCRIBE_VARIABLE_SHADOWING_IN_SWIFT_AND_ITS_EFFECT_ON_DATA_ACCESS` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-02-2' không tồn tại. |
| learning_objectives | `SIO-SWIFT-WRITE_A_SWIFT_FUNCTION_WITH_MULTIPLE_RETURN_STATEMENTS_IN_CONDITIONAL_BRANCHES` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-03-1' không tồn tại. |
| learning_objectives | `SIO-SWIFT-WRITE_A_SWIFT_FUNCTION_WITH_MULTIPLE_RETURN_STATEMENTS_IN_CONDITIONAL_BRANCHES_2` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-03-1' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DESIGN_A_SWIFT_FUNCTION_WITH_SIDE_EFFECTS_ON_GLOBAL_STATE_AND_RETURN_VALUE` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-03-2' không tồn tại. |
| learning_objectives | `SIO-SWIFT-DESIGN_A_SWIFT_FUNCTION_WITH_SIDE_EFFECTS_ON_GLOBAL_STATE_AND_RETURN_VALUE_2` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-03-2' không tồn tại. |
| learning_objectives | `SIO-SWIFT-USE_RETURN_VALUE_AS_DIRECT_ARGUMENT_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-03-3' không tồn tại. |
| learning_objectives | `SIO-SWIFT-ASSIGN_RETURN_VALUE_TO_CONSTANT_AND_USE_IN_SUBSEQUENT_EXPRESSION_IN_SWIFT` | parent_lo_code | parent_lo_code 'CIO-RETURN_VALUES_AND_SCOPE-03-3' không tồn tại. |
...
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-LIST_AND_CLASSIFY` | - | CIO 'Liệt kê và phân loại UI Modifier' (CIO-UI_MODIFIERS_CONCEPT-LIST_AND_CLASSIFY) chỉ có 0 SIO con (yêu cầu ≥ 2). Phân rã chưa đủ chi tiết thực hành. |
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-ORDER_AFFECTS_DISPLAY` | - | CIO 'Thứ tự áp dụng modifier ảnh hưởng đến kết quả hiển thị' (CIO-UI_MODIFIERS_CONCEPT-ORDER_AFFECTS_DISPLAY) chỉ có 0 SIO con (yêu cầu ≥ 2). Phân rã chưa đủ chi tiết thực hành. |
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-COMBINE_MODIFIERS` | - | CIO 'Kết hợp các modifier để tạo hiệu ứng tổng hợp' (CIO-UI_MODIFIERS_CONCEPT-COMBINE_MODIFIERS) chỉ có 0 SIO con (yêu cầu ≥ 2). Phân rã chưa đủ chi tiết thực hành. |
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-SELECT_BY_LAYOUT` | - | CIO 'Lựa chọn modifier dựa trên yêu cầu bố cục' (CIO-UI_MODIFIERS_CONCEPT-SELECT_BY_LAYOUT) chỉ có 0 SIO con (yêu cầu ≥ 2). Phân rã chưa đủ chi tiết thực hành. |
| learning_objectives | `CIO-UI_MODIFIERS_CONCEPT-ORDER_FOR_EFFECT` | - | CIO 'Sắp xếp thứ tự modifier để đạt hiệu quả mong muốn' (CIO-UI_MODIFIERS_CONCEPT-ORDER_FOR_EFFECT) chỉ có 0 SIO con (yêu cầu ≥ 2). Phân rã chưa đủ chi tiết thực hành. |
...
| concepts | `SYNTAX_VS_RUNTIME_ERRORS` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |
| concepts | `WHILE_LOOP` | - | Không có node nào ở tầng dưới tham chiếu tới node này. |

### `LO_CONCEPT_UNCOVERED` (6) — Concept trong concepts.tsv không được LO nào trỏ đến (thiếu coverage)

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| concepts | `ARRAY_OPERATIONS` | - | Concept 'Array Operations' (ARRAY_OPERATIONS) không có LO nào trỏ đến trong learning-objectives.tsv. |
...
| concepts | `WHILE_LOOP` | - | Concept 'While Loop' (WHILE_LOOP) không có LO nào trỏ đến trong learning-objectives.tsv. |
| concepts | `SYNTAX_VS_RUNTIME_ERRORS` | - | Concept 'Syntax vs Runtime Errors' (SYNTAX_VS_RUNTIME_ERRORS) không có LO nào trỏ đến trong learning-objectives.tsv. |
...
### `INCONSISTENT_LINE_ENDINGS` (3) — File dùng line-ending khác với đa số các file còn lại

| Tầng | Code | Cột | Chi tiết |
|---|---|---|---|
| _file | `categories.tsv` | - | File dùng line-ending LF, khác đa số các file khác (CRLF). |
| _file | `topics.tsv` | - | File dùng line-ending LF, khác đa số các file khác (CRLF). |
