...
- **Generated:** 2026-07-27T08:21:01.261796+00:00
...
**50 CIO(s) vi phạm tính Trung tính (Marr Test):**
...
| `CIO-OBJECT_PROPERTIES-IDENTIFY_PROPERTY_AS_KEY` | Identify Property as Key-Value Pair Using Swift Syntax | `struct`, `swift` |
...
| `CIO-RETURN_VALUES_AND_SCOPE-IDENTIFY_RETURN_STATEMENT_SYNTAX` | Identify Return Statement Syntax in Swift Functions | `swift`, `func` |
...
| `CIO-TYPE_SYSTEM-IDENTIFY_STATIC_TYPING_IN` | Identify static typing in Swift via type annotation and inference | `swift`, `annotation` |
...
| `CIO-VIEW_CONCEPT-MODEL_VIEW_AS_SWIFTUI` | Model View as SwiftUI Struct | `struct` |
