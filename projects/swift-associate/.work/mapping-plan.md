...
**Phân tích LO:** Variables, Loops, Functions, Arrays, Conditionals.
- **Field:** `ASE`
...
- **Category & Topic Mappings:** Hoàn toàn tái sử dụng được Master Tree vì đây là nền tảng lập trình cơ bản.
  - `ULO-PROG-STATE` -> **Concept:** `VARIABLES`, `DATA_TYPES` (Có sẵn)
  - `ULO-ITERATION` -> **Concept:** `FOR_LOOP`, `WHILE_LOOP` (Có sẵn)
  - Kế hoạch: Tái sử dụng `VARIABLES_DATA_TYPES`, `CONTROL_FLOW`, `FUNCTIONS_METHODS`, `DATA_STRUCTURES`.
