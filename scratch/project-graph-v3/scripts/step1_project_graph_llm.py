...
BASE_SYSTEM = (
    ...
    "  - Giai đoạn 1 nên là 'app chạy được UI cơ bản' (scaffold + UI shell + navigation) — "
    "người học THẤY kết quả ngay, build chạy trên simulator.\n"
    "  - Backend/config nặng (Firebase configure, singleton, API keys) KHÔNG được nhét vào giai "
    "đoạn 1 — đẩy xuống giai đoạn sau khi đã có UI chạy.\n"
