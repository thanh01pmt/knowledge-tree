...
def fix_tsv(tsv_path: Path):
    ...
    CONCEPT_RENAME = {
        "STATIC_ATTRIBUTES": "STATIC_ATTRIBUTES_CONCEPT",
        "FIRST_CLASS_VALUES": "FIRST_CLASS_VALUES_CONCEPT",
        "IMMUTABLE_CONCEPTS": "IMMUTABLE_CONCEPTS_CONCEPT",
        "ASYNC_PATTERNS": "ASYNC_PATTERNS_CONCEPT",
        "ROUTING_SWITCHING": "ROUTING_SWITCHING_CONCEPT",
        "MEDIUM_TYPES": "MEDIUM_TYPES_CONCEPT",
        "TOPOLOGY_STRUCTURES": "TOPOLOGY_STRUCTURES_CONCEPT",
        "IOT_PROTOCOLS_MQTT": "IOT_MESSAGING_PROTOCOLS",
        "MECHANICAL_SIMPLE": "MECHANICAL_SIMPLE_CONCEPT",
        "ELECTRONIC_ELEMENTS": "ELECTRONIC_ELEMENTS_CONCEPT",
        "CIRCUIT_FUNDAMENTALS": "CIRCUIT_FUNDAMENTALS_CONCEPT",
        "PASSWORD_CRITERIA": "PASSWORD_CRITERIA_CONCEPT",
        "EVENT_LISTENERS": "EVENT_LISTENERS_CONCEPT",
        "MALWARE_KINDS": "MALWARE_KINDS_CONCEPT",
        "CONSTRAINT_MECHANICS": "CONSTRAINT_MECHANICS_CONCEPT",
        "UI_MODIFIERS": "UI_MODIFIERS_CONCEPT",
        "TROUBLESHOOTING_STEPS": "TROUBLESHOOTING_STEPS_CONCEPT",
        "ERROR_MSG_PARSING": "ERROR_MSG_PARSING_CONCEPT",
    }
    ...
    CONCEPT_EXPLICIT_TOPIC = {
        ...
        "SYNTAX_ERRORS": "ERROR_MSG_PARSING",
