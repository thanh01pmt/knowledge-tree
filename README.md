...
| `/audit-curriculum` | `@knowledge-researcher` | ✅ | **Tier 1**: Cross-reference Master Tree with STEM frameworks (NGSS, ACM) for gaps |
| `/watch-trends` | `@knowledge-researcher` | ✅ | **Tier 2**: Deep web scan for emerging tech, auto-prioritize to Research Queue |
...
- **Sub-Servers**:
  ...
  - `research`: Discovery tools (`research_audit_curriculum`, `research_watch_trends`)
