...
#### 2. TURN/TLS fails with unknown_ca when root is missing from WebRTC bundle (score 36, 1 item, sources: GitHub)
1. [github] TURN/TLS fails with unknown_ca when root is missing from WebRTC bundle
   - 2026-07-30 | livekit/rust-sdks | [6react] | score:36
...
#### 4. Questions and answers on AI and verification: follow-up to my May ACM Tech Talk (score 32, 1 item, sources: Hacker News)
1. [hackernews] Questions and answers on AI and verification: follow-up to my May ACM Tech Talk
   - 2026-07-28 | Hacker News | [4pts] | score:32
...
└─ 📎 Raw results saved to /opt/data/my-projects/knowledge-tree/.work/research/acm-raw-2026-08-02-1.md
---
